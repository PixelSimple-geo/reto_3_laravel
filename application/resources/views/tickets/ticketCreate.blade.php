            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('tickets.ticketStore') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="idPedido" class="block text-sm font-medium text-gray-700">Pedido:</label>
                        ...
                        <div class="mb-4">
                            <label for="idFormatoProducto" class="block text-sm font-medium text-gray-700">ID Formato Producto:</label>
